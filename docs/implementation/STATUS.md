...
- [ ] Full parity and targeted exceedance are not complete; external exactly-once scheduling and live crash studies for orchestration, live broad mobile/messaging reach, production STT/TTS/mobile execution, live human outcome studies and causal attribution, live third-party package attestation and marketplace operations, external browser-provider attestation, and denser long-running operator control remain open.
...
- [x] The next strategic focus is now post-proof-train hardening: live-provider attestation beyond deterministic replay, denser operator/debug ergonomics, live marketplace attestation and operations beyond deterministic lifecycle receipts, and stronger guardian learning on top of the expanded capability surface. Secure-host hardening has Batch BW receipts, durable orchestration has Batch BX receipts, reach/browser/voice hardening has Batch BY receipts, live learning/provider outcome proof has Batch BZ receipts, and marketplace lifecycle maturity has Batch CA receipts; host/container-grade privileged execution isolation, broad live reach, production STT/TTS/mobile execution, live human outcome studies, production marketplace security, and full browser/computer-use parity remain future stronger-proof boundaries.
...
- [ ] The biggest gaps against the reference systems are now external exactly-once scheduling and live crash studies beyond durable-orchestration v2 receipts, deeper execution hardening beyond deterministic choke-point proof, denser step-level workflow/operator debugging beyond the new triage and evidence-control layer, live human outcome studies and causal attribution beyond Batch BZ outcome/provider receipts, broad daily-life reach beyond the native-notification canary, live marketplace attestation and operations beyond Batch CA lifecycle receipts, and production-grade hardening for the broadened reach surface.
