...
- [ ] The biggest implementation gaps now cluster around deeper privileged execution isolation beyond the new field-scoped secret-ref and mutation-allowlist layer, denser operator/debug ergonomics, deeper intervention learning, richer world-model quality beyond the new ranking/arbitration diagnostics, production-grade hardening for the broadened reach surfaces, and cleaner provider-neutral capability/adapter seams.
