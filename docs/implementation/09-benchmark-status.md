...
- [ ] The biggest implementation gaps still cluster around cockpit density, salience-aware intervention quality, workflow control ergonomics, execution hardening, and richer native reach.
