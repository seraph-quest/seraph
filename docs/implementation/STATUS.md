...
- [ ] Full parity and targeted exceedance are not complete; external exactly-once scheduling and live crash studies for orchestration, live broad mobile/messaging reach, production STT/TTS/mobile execution, live human outcome studies and causal attribution, live third-party package attestation and marketplace operations, external browser-provider attestation, live multi-operator usability, and production security/superiority evidence remain open.
...
- [x] The next strategic focus is now post-proof-train hardening: live-provider attestation beyond deterministic replay, live marketplace attestation and operations beyond deterministic lifecycle receipts, and stronger guardian learning on top of the expanded capability surface. Secure-host hardening has Batch BW receipts, durable orchestration has Batch BX receipts, reach/browser/voice hardening has Batch BY receipts, live learning/provider outcome proof has Batch BZ receipts, marketplace lifecycle maturity has Batch CA receipts, and production operator-control/train verification has Batch CB receipts; host/container-grade privileged execution isolation, broad live reach, production STT/TTS/mobile execution, live human outcome studies, production marketplace security, full browser/computer-use parity, and reference-system exceedance remain future stronger-proof boundaries.
...
- [ ] The biggest gaps against the reference systems are now external exactly-once scheduling and live crash studies beyond durable-orchestration v2 receipts, deeper execution hardening beyond deterministic choke-point proof, live human outcome studies and causal attribution beyond Batch BZ outcome/provider receipts, broad daily-life reach beyond the native-notification canary, live marketplace attestation and operations beyond Batch CA lifecycle receipts, live multi-operator usability beyond Batch CB operator-control receipts, and production-grade hardening for the broadened reach surface.
