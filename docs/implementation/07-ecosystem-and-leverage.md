...
- [ ] richer extension health/test surfaces, deeper marketplace curation, production marketplace security, independent package-security audit, and production-grade connector hardening beyond the current lifecycle API, governance queue, diagnostics summaries, operator health triage, marketplace-flow composition, M9 governed-ecosystem proof, Batch CA lifecycle proof, Batch CG recorded-live attestation/operations proof, and deterministic eval coverage
