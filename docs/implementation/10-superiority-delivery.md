...
- [ ] still missing: stronger privileged execution isolation, clearer authenticated-source and connector boundaries, and disposable execution or recovery containment beyond the new operator-aware replay/native-resume hardening plus field-scoped secret-ref and mutation-allowlist layer
