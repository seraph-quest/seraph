...
from src.extensions.marketplace_production_security import build_marketplace_production_security_report
from src.extensions.post_dp_marketplace_lifecycle_gap_closure import build_post_dp_marketplace_lifecycle_report
...
async def get_operator_benchmark_proof():
    ...
    (
        ...
        post_dx_live_durable_orchestration,
        ...
        marketplace_production_security,
        post_dp_marketplace_lifecycle,
    ...
    child_benchmark_postures = [
        ...
        str(post_dx_live_durable_orchestration["summary"]["benchmark_posture"]),
        ...
        str(marketplace_production_security["summary"]["benchmark_posture"]),
        str(post_dp_marketplace_lifecycle["summary"]["benchmark_posture"]),
        ...
        str(post_dp_operator_debugging_recovery["summary"]["benchmark_posture"]),
        ...
        str(post_dx_final_claim_lift["summary"]["benchmark_posture"]),
    ]
    ...
    return {
        "summary": {
            ...
            "production_sla_orchestration_posture": production_sla_orchestration["summary"]["benchmark_posture"],
            ...
            "production_orchestration_hard_guarantees_posture": production_orchestration_hard_guarantees[
                "summary"
            ]["benchmark_posture"],
            "production_orchestration_hard_guarantees_claim_boundary": production_orchestration_hard_guarantees[
                "policy"
            ]["claim_boundary"],
            ...
            "post_dx_live_durable_orchestration_posture": post_dx_live_durable_orchestration[
                "summary"
            ]["benchmark_posture"],
            "post_dx_live_durable_orchestration_claim_boundary": post_dx_live_durable_orchestration[
                "policy"
            ]["claim_boundary"],
            "post_dx_live_durable_orchestration_operator_status": post_dx_live_durable_orchestration[
                "summary"
            ]["operator_status"],
            ...
            "live_guardian_learning_quality_posture": live_guardian_learning_quality["summary"]["benchmark_posture"],
            ...
            "live_reach_media_claim_boundary": live_reach_media["policy"]["claim_boundary"],
            "production_reach_voice_mobile_posture": production_reach_voice_mobile["summary"]["benchmark_posture"],
            ...
            "reach_voice_production_ops_posture": reach_voice_production_ops["summary"]["benchmark_posture"],
            "reach_voice_production_ops_claim_boundary": reach_voice_production_ops["policy"]["claim_boundary"],
            "reach_voice_production_ops_operator_status": reach_voice_production_ops["summary"]["operator_status"],
            ...
            "marketplace_production_security_posture": marketplace_production_security["summary"][
                "benchmark_posture"
            ],
            "marketplace_production_security_claim_boundary": marketplace_production_security["policy"][
                "claim_boundary"
            ],
            "marketplace_production_security_operator_status": marketplace_production_security["summary"][
                "operator_status"
            ],
            "post_dp_marketplace_lifecycle_posture": post_dp_marketplace_lifecycle["summary"][
                "benchmark_posture"
            ],
            "post_dp_marketplace_lifecycle_claim_boundary": post_dp_marketplace_lifecycle["policy"][
                "claim_boundary"
            ],
            "post_dp_marketplace_lifecycle_operator_status": post_dp_marketplace_lifecycle["summary"][
                "operator_status"
            ],
            ...
            "full_browser_parity_posture": full_browser_parity["summary"]["benchmark_posture"],
            "full_browser_parity_claim_boundary": full_browser_parity["policy"]["claim_boundary"],
            "browser_computer_use_production_posture": browser_computer_use_production["summary"][
                "benchmark_posture"
            ],
            "browser_computer_use_production_claim_boundary": browser_computer_use_production["policy"][
                "claim_boundary"
            ],
            ...
            "post_dp_operator_debugging_recovery_posture": post_dp_operator_debugging_recovery["summary"][
                "benchmark_posture"
            ],
            "post_dp_operator_debugging_recovery_claim_boundary": post_dp_operator_debugging_recovery[
                "policy"
            ]["claim_boundary"],
            "post_dp_operator_debugging_recovery_operator_status": post_dp_operator_debugging_recovery[
                "summary"
            ]["operator_status"],
            ...
            "post_cq_claim_readiness_claim_boundary": post_cq_claim_readiness["policy"]["claim_boundary"],
            "final_production_parity_posture": final_production_parity["summary"]["benchmark_posture"],
            ...
            "post_dx_final_claim_lift_posture": post_dx_final_claim_lift["summary"][
                "benchmark_posture"
            ],
            "post_dx_final_claim_lift_claim_boundary": post_dx_final_claim_lift["policy"][
                "claim_boundary"
            ],
            "post_dx_final_claim_lift_operator_status": post_dx_final_claim_lift["summary"][
                "operator_status"
            ],
        },
        "suites": suites,
        ...
        "post_dx_live_durable_orchestration": post_dx_live_durable_orchestration,
        ...
        "marketplace_production_security": marketplace_production_security,
        "post_dp_marketplace_lifecycle": post_dp_marketplace_lifecycle,
        ...
        "post_dp_operator_debugging_recovery": post_dp_operator_debugging_recovery,
        ...
        "post_dx_final_claim_lift": post_dx_final_claim_lift,
...
@router.get("/operator/live-workflow-endurance-canary")
async def get_operator_live_workflow_endurance_canary():
...
@router.get("/operator/production-sla-orchestration")
async def get_operator_production_sla_orchestration():
    return await build_production_sla_orchestration_report()
...
@router.get("/operator/post-dx-live-durable-orchestration")
async def get_operator_post_dx_live_durable_orchestration():
    return await build_post_dx_live_durable_orchestration_report()
...
@router.get("/operator/live-guardian-learning-quality")
async def get_operator_live_guardian_learning_quality():
    return await build_live_guardian_learning_quality_report()
...
async def get_operator_production_reach_browser_voice():
    return await build_production_reach_browser_voice_report()


@router.get("/operator/live-reach-media-proof")
async def get_operator_live_reach_media_proof():
    return await build_live_reach_media_report()


@router.get("/operator/production-reach-voice-mobile")
async def get_operator_production_reach_voice_mobile():
    return await build_production_reach_voice_mobile_report()
...
@router.get("/operator/reach-voice-production-ops")
async def get_operator_reach_voice_production_ops():
    return await build_reach_voice_production_ops_report()
...
@router.get("/operator/marketplace-production-security")
async def get_operator_marketplace_production_security():
    return await build_marketplace_production_security_report()


@router.get("/operator/post-dp-marketplace-lifecycle-gap-closure")
async def get_operator_post_dp_marketplace_lifecycle_gap_closure():
    return await build_post_dp_marketplace_lifecycle_report()
...
@router.get("/operator/full-browser-parity")
async def get_operator_full_browser_parity():
    return await build_full_browser_parity_report()
...
@router.get("/operator/post-dp-operator-debugging-recovery-control")
async def get_operator_post_dp_operator_debugging_recovery_control():
    return await build_post_dp_operator_debugging_recovery_report()
...
@router.get("/operator/post-cq-claim-readiness")
async def get_operator_post_cq_claim_readiness():
    return await build_post_cq_claim_readiness_report()


@router.get("/operator/final-production-parity")
async def get_operator_final_production_parity():
    return await build_final_production_parity_report()
...
@router.get("/operator/post-dx-final-parity-claim-lift")
async def get_operator_post_dx_final_parity_claim_lift():
    return await build_post_dx_final_claim_lift_report()
