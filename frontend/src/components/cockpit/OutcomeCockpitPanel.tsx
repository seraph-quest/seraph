...
export interface OutcomeApprovalSummary {
  ...
  boundRevision?: string | number | null;
}
    ...
    >
      ...
      <div className="cockpit-outcome-grid">
        ...
        >
          {approval ? (
            <>
              ...
              <ValueRow label="approval expiry" value={display(approval.approvalExpiry ?? approval.ownerExpiry)} />
              <ValueRow label="bound revision" value={display(approval.boundRevision, "revision unavailable")} />
            </>
          ) : (
            <div className="cockpit-outcome-empty">
        ...
        >
          ...
          <ValueRow label="receipt type" value={display(result.receiptType, "outcome unavailable")} />
          <ValueRow label="candidate" value={display(result.candidateId, "candidate unavailable")} />
          <ValueRow label="attempt/outcome" value={display(result.outcomeId, "attempt unavailable")} />
