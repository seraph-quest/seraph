...
- [ ] broad always-available mobile and messaging transports remain future work; the current M4, one-channel canary, Batch BY hardening proof, and Batch CE live/recorded-live proof pin native-notification identity, paired external messaging, mobile-push and messaging provider receipts, revocation, mutation-boundary, continuity, approval, privacy, degraded-state, voice/media provider fallback, and review receipts without claiming Slack, Discord, Telegram, voice, mobile, STT/TTS, or full browser reach at production scale
...
- [ ] broad always-available mobile, messaging, voice, STT/TTS, or multimodal transport execution is not claimed by these proof lanes
