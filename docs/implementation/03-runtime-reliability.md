...
- [ ] expand eval coverage beyond deterministic seam checks into broader behavioral contracts, even with daily-briefing, activity-digest, and evening-review degraded-input auditing now covered
