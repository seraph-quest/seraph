...
| Protected tool authority gate | `backend/src/tools/approval.py`, `backend/tests/test_approval_tools.py` | Real v1 enforcement for wrapped high-risk/forced tools; missing session or principal denies before approval lookup or execution, while direct, unwrapped, and low-risk adoption remains #747 |
