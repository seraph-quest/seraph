...
- [ ] still missing: richer direct workflow control, deeper step-level workflow history, easier extension ergonomics, and broader authenticated connector execution beyond the first connector-backed read bridge and the shipped step records, branch-family supervision, artifact source/family follow-through, checkpoint branch controls, first cockpit timeline, operator terminal, and public-web source-evidence layer
