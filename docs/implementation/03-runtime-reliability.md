...
> **OpenRouter-only Epic contract:** Epic #736/#775 makes OpenRouter the
...
for historical traceability; active inference in the accepted #775 phase uses the
...
- [x] **Historical develop baseline:** a local or non-OpenRouter path was demonstrably possible across helper, scheduled completion jobs, core agent, delegation, and connected MCP-specialist flows; the accepted #775 phase blocks those paths and admits only governed OpenRouter inference
