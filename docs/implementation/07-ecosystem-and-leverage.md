...
- [ ] richer extension health/test surfaces, live third-party package attestation, deeper marketplace curation, production marketplace security, and production-grade connector hardening beyond the current lifecycle API, governance queue, diagnostics summaries, operator health triage, marketplace-flow composition, M9 governed-ecosystem proof, Batch CA lifecycle proof, and deterministic eval coverage
