...
def _builtin_provider_profiles() -> dict[str, ProviderProfile]:
    profiles = {
        ...
        "codex-openai": ProviderProfile(
            ...
            task_class="coding",
            budget_class="high",
            safety_notes="OpenAI GPT-5.5 profile with low reasoning effort configured as a request option.",
        ),
        "gpt-5.5-low": ProviderProfile(
            ...
            task_class="coding",
            budget_class="high",
            safety_notes="Compatibility alias for codex-openai; model remains gpt-5.5 and reasoning_effort stays a request option.",
        ),
