...
def test_completion_with_fallback_sync_routes_codex_local_to_local_operator(async_db, transitional_legacy_completion_path):
    with (
...
async def test_completion_with_fallback_sync_fails_fast_for_codex_local_inside_running_loop(async_db, transitional_legacy_completion_path):
    with (
        patch.object(settings, "default_model", "codex-local"),
        patch.object(settings, "runtime_profile_preferences", ""),
        patch.object(settings, "runtime_model_overrides", ""),
