...
| `test_guardian_state.py` | 4 | Guardian-state synthesis — state assembly, confidence labels, recent feedback injection, agent injection, strategist context |
