...
- [ ] broad always-available mobile and messaging transports remain future work; the current M4, one-channel canary, Batch BY hardening proof, Batch CE live/recorded-live proof, and Batch CH browser-provider/usability receipts pin native-notification identity, paired external messaging, mobile-push and messaging provider receipts, browser provider identity/evidence mode, browser session and credential boundaries, revocation, mutation-boundary, continuity, approval, privacy, degraded-state, voice/media provider fallback, browser fail-closed recovery, and review receipts without claiming Slack, Discord, Telegram, voice, mobile, STT/TTS, safe autonomous browser/computer-use, or full browser reach at production scale
