...
- [ ] The biggest implementation gaps now cluster around privileged execution hardening, denser operator/debug ergonomics, deeper intervention learning, richer world-model quality, and production-grade hardening for the broadened reach surfaces.
