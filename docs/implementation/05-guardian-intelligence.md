...
- [ ] richer human world modeling that goes beyond the new project/routine/collaborator/obligation/timeline-aware world-model layer plus active blockers, next-up, dominant-thread synthesis, memory buckets, focus-provenance tracking, the first explicit user-model confidence and preference-inference substrate, stale-support and stale-execution contradiction grounding, and contradiction-aware confidence downgrades
