...
- [x] The next strategic focus is now post-import hardening: deeper execution isolation beyond the new field-scoped secret-ref, mutation-allowlist, workspace-escape blocking, browser partition strategy, hostile-provider replay receipts, and session-bound process-recovery layer, denser operator/debug ergonomics, production-grade reach hardening, and stronger guardian learning on top of the expanded capability surface.
