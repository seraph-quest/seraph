...
- [x] active workflow triage now also exposes direct `use output`, `compare best`, `draft next step`, and keyboard-first latest-branch follow-through so routine workflow recovery does not require an inspector hop for every next action
