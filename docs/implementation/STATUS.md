...
- [ ] richer cockpit density and broader keyboard/operator control beyond the current workflow, activity-ledger, imported-reach, governance, active-triage, evidence-shortcut, artifact follow-through, and first keyboard-first command surfaces
...
- [ ] deeper operator-facing workflow control and workflow history beyond the new workflow-runs API, typed artifact handoff, artifact source/family follow-through, checkpoint branch controls, replay guardrails, timeline events, and cockpit workflow timeline
