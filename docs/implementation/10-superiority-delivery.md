...
- [ ] still missing: stronger privileged execution isolation, clearer authenticated-source and connector boundaries, and broader disposable execution isolation beyond the new operator-aware replay/native-resume hardening plus field-scoped secret-ref, mutation-allowlist, and session-bound process-recovery layer
