...
- [x] deterministic eval harness coverage for core runtime, audit, observer, storage, tool-boundary, MCP test API, skills API, screen repository, and daily-briefing plus evening-review degraded-input contracts
